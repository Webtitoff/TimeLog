		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="home-gallery-wrap mfp-gallery">
						...
						<div class="gallery-images">
							<a href="assets/app/img/photos/1.jpg" data-preview="assets/app/img/photos/1.jpg"></a>
							<a href="assets/app/img/photos/2.jpg" data-preview="assets/app/img/photos/2.jpg"></a>
							<a href="assets/app/img/photos/3.jpg" data-preview="assets/app/img/photos/3.jpg"></a>
						</div>
				...
				<div class="col-sm-6">
					...
					<p>Обращаясь в нашу компанию, вы гарантированно получаете высокое качество проектирования и монтажа вентиляционных систем. <strong>ОВК СТРОЙ</strong> - это команда профессионалов с многолетним опытом работы на рынке.</p>

					<ul class="home-list">
						<li><i class="fa fa-plus"></i> Работаем без предоплаты</li>
						<li><i class="fa fa-plus"></i> Бесплатный выезд инженера</li>
					</ul>
						...
						<div class="col-md-6">
							<div class="certificate-wrap mfp-gallery">
								...
								<div class="certificates">
									<a href="assets/app/img/certificate/certificate.jpg"></a>
									<a href="assets/app/img/certificate/certificate_2.jpg"></a>
								</div>
							</div>
						</div>
					</div>
